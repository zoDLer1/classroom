"""
Django settings for drf_back project.
...
WSGI_APPLICATION = 'drf_back.wsgi.application'
...
SIMPLE_JWT = {
    ...
    "TOKEN_REFRESH_SERIALIZER": "accounts.serializers.RefreshTokenSerializer",
