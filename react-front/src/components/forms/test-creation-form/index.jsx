...
export default () =>  {
    ...
    const [formData, setData] = useState({name: '', description: '', time: '', type: {name:'Simple', id: 1}, questions: [defaultQuestionValue]})
    ...
    return (
        <form className={css.block}>
            ...
            <QuestionList questions={formData.questions} set={setQuestions} testType={formData.type} defaultValue={defaultQuestionValue}/>
