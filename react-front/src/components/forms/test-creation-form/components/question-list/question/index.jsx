...
export default (props) => {
    ...
    const [type, setType] = useState(props.data.answer_type)
    ...
    const setTime = (value) =>{
        props.set(props.numb, { ...props.data, time: Number(value) })
    }
    ...
    return (
        <div className={css.block}>
            ...
            <div className={css.header}>
                ...
                <Select value={type.name} select={setQuestionType} options={types} name={`question_${props.numb}_type`} placeholder="Answer type" icon='fa-solid fa-list-ol' />
            </div>
            ...
            <div className={css.body}>
                ...
                {props.testType.id === 2 && <div className={css.time}>
                    <Input onChange={(evt) => setTime(evt.target.value)} type="number" name={`question_${props.numb}_time`} placeholder="Time" icon='fa-regular fa-clock' />
                </div>}
            ...
            <div className={css.footer}>
                <div className={css.actions}>
                    ...
                    <i onClick={()=>props.copy(props.data)} className={`${[css.icon, css.action, css.copy].join(' ')} fa-regular fa-copy`}></i>
                </div>
            ...
            <div className={css.menu}>
                <div className={css.menu_body}>
                    <div>
                        <i className={`${css.item} ${css.fs24} fa-solid fa-circle-plus`}></i>
                    </div>
                    <div>
